...
/* Generated from ../O.Common/forgottenIOC.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "devaiStream", "devAoSoft",
    ...
    "asynMbbiInt32", "asynMbbiUInt32Digital", "devmbbiStream",
    ...
    "asynFloat64TimeSeries", "devwaveformStream"
};
...
int forgottenIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/repos/forgottenIOC";
...
/* forgottenIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"forgottenIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    forgottenIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
